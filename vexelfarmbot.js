...
console.log("Discord: vexel53");
console.log("Vexel socket client sorunsuz şekilde çalışıyor...");
...
console.log(chalk.cyan("Discord: vexel53"));
console.log(chalk.cyan("Vexel Tarafından Yapıldı"));

if (settings.huntandbattle == "true") {
    console.log(
        chalk.magenta("Vexel OwO Farm Bot Çalışıyor... ") +
...
if (settings.banbypass == "true") {
    ...
    console.log(
        chalk.yellow("Captcha (ban) Bypass System by Vexel ") +
        chalk.blue(`version ${banversion}`)
    );
    console.log(`{/__/}\n( ^ . ^)\n/ > ` + chalk.red("Vexel Captcha Bypass"));
} else {
        ...
        request.get(
            ...
            function (err, res, body) {
                ...
                if (bod.updater === require("./version.json").updater) {
                    console.log(
                        chalk.yellow(
                            `Updater Repo Version: ${bod.updater
                            } / Updater Installed Version: ${require("./version.json").updater
                            }`
                        )
                    );
                } else {
